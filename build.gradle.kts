...
buildscript {
  ...
  dependencies {
    ...
    // ANONYMOUS: wire-handler factory now in buildSrc, no manual classpath needed
...
subprojects {
  // ANONYMOUS: Limit concurrency of high-RAM tasks to avoid OOMs (especially in CI).
  ...
  // ANONYMOUS: Add task `./gradlew allDeps` to list all dependencies for each configuration
