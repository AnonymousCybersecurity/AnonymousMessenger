  ...
  private fun getConfiguration(state: InternalSettingsState): DSLConfiguration {
    return configure {
      ...
      clickPref(
        ...
        summary = DSLSettingsText.from("Make as Anonymous never received the ping from AnonymousSocket. Will cause UnifiedPush to stop and Websocket to restart."),
        onClick = {
          MaterialAlertDialogBuilder(requireContext())
      ...
      clickPref(
        ...
        onClick = {
          ...
          MegaphoneDatabase.getInstance(AppDependencies.application).let {
            ...
            it.markFirstVisible(Megaphones.Event.DONATE_ANONYMOUS, System.currentTimeMillis() - TimeUnit.DAYS.toMillis(31))
          }
