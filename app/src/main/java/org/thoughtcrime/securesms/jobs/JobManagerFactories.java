...
public final class JobManagerFactories {
  ...
  public static Map<String, Job.Factory> getJobFactories(@NonNull Application application) {
    return new HashMap<>() {{
      ...
      put("AllDataSyncRequestJob",                     new FailingJob.Factory()); // ANONYMOUS
      ...
      put("CallQualitySurveySubmission",               new FailingJob.Factory()); // ANONYMOUS
      ...
      put(UnifiedPushRefreshJob.KEY,                   new UnifiedPushRefreshJob.Factory());  // ANONYMOUS
      ...
      put("InAppPaymentGiftSendJob",                   new FailingJob.Factory()); // ANONYMOUS
      ...
      put("MultiDeviceOutgoingPaymentSyncJob",         new FailingJob.Factory()); // ANONYMOUS
      ...
      put("PaymentLedgerUpdateJob",                    new FailingJob.Factory()); // ANONYMOUS
      put("PaymentNotificationSendJob",                new FailingJob.Factory()); // ANONYMOUS
      put("PaymentNotificationSendJobV2",              new FailingJob.Factory()); // ANONYMOUS
      put("PaymentSendJob",                            new FailingJob.Factory()); // ANONYMOUS
      put("PaymentTransactionCheckJob",                new FailingJob.Factory()); // ANONYMOUS
      ...
      put("SendPaymentsActivatedJob",                  new FailingJob.Factory()); // ANONYMOUS
      ...
      put("AvatarMigrationJob",                           new FailingJob.Factory());  // ANONYMOUS
      ...
      put("CachedAttachmentsMigrationJob",                new FailingJob.Factory());  // ANONYMOUS
      ...
      put("LegacyMigrationJob",                           new FailingJob.Factory());  // ANONYMOUS
      ...
      put("RecheckPaymentsMigrationJob",                  new FailingJob.Factory());  // ANONYMOUS
      put(ReleaseChannelRecipientFixMigrationJob.KEY,     new ReleaseChannelRecipientFixMigrationJob.Factory());
      put("RecipientSearchMigrationJob",                  new FailingJob.Factory());  // ANONYMOUS
      put("ResetArchiveTierMigrationJob",                 new FailingJob.Factory());  // ANONYMOUS
      put(SelfRegisteredStateMigrationJob.KEY,            new SelfRegisteredStateMigrationJob.Factory());
      put("StickerLaunchMigrationJob",                    new FailingJob.Factory());  // ANONYMOUS
      ...
      put("UuidMigrationJob",                             new FailingJob.Factory());  // ANONYMOUS
