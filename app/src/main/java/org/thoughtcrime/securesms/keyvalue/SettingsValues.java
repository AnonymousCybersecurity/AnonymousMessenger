...
public final class SettingsValues extends SignalStoreValues {
  ...
  private static final String ANONYMOUS_NOTIFICATION_METHOD               = "anonymous.notificationMethod";
  ...
  void onFirstEverAppLaunch() {
    ...
    // ANONYMOUS: These settings are saved in shared prefs too. Sync with the stored values.
  ...
  public void setTheme(@NonNull Theme theme, boolean useDynamicColors) {
    ...
    // ANONYMOUS: Store the value unencrypted to be able to read it back when app is locked
  ...
  public void setLanguage(@NonNull String language) {
    // ANONYMOUS: Keep language setting in SharedPreferences
  ...
  public NotificationDeliveryMethod getPreferredNotificationMethod() {
    ...
    if (getStore().containsKey(ANONYMOUS_NOTIFICATION_METHOD)) {
      method = NotificationDeliveryMethod.deserialize(
          getString(ANONYMOUS_NOTIFICATION_METHOD, NotificationDeliveryMethod.FCM.serialize())
      );
    } else {
  ...
  public void setPreferredNotificationMethod(NotificationDeliveryMethod method) {
    putString(ANONYMOUS_NOTIFICATION_METHOD, method.serialize());
  }
