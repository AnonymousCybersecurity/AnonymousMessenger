...
public class TextSecurePreferences {
  ...
  private static final String[] booleanPreferencesToBackupAnonymous = {
      LOG_ENABLED,
      UPDATE_APK_ENABLED,
  ...
  private static final String[] stringSetPreferencesToBackupAnonymous = {PASSPHRASE_LOCK_TRIGGER};

  private static final String[] integerPreferencesToBackupAnonymous = {PASSPHRASE_LOCK_TIMEOUT};
  ...
  public static long getPreferencesToSaveToBackupCount(@NonNull Context context) {
    ...
    for (String booleanPreference : booleanPreferencesToBackupAnonymous) {
      if (preferences.contains(booleanPreference)) {
        count++;
      }
    }

    for (String stringSetPreference : stringSetPreferencesToBackupAnonymous) {
      if (preferences.contains(stringSetPreference)) {
        count++;
      }
    }

    for (String integerPreference : integerPreferencesToBackupAnonymous) {
  ...
  public static int getLastVersionCodeForAnonymous(Context context) {
    return getIntegerPreference(context, LAST_VERSION_CODE_PREF, BuildConfig.VERSION_CODE);
  }

  public static void setLastVersionCodeForAnonymous(Context context, int versionCode) {
