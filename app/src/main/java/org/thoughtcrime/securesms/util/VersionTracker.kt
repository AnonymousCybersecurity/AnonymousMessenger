...
object VersionTracker {
  ...
  @JvmStatic
  fun getLastSeenVersionForAnonymous(context: Context): Int {
    return TextSecurePreferences.getLastVersionCodeForAnonymous(context)
  }

  @JvmStatic
  fun updateLastSeenVersion(context: Context) {
    val currentVersionCode = BuildConfig.VERSION_CODE
    val lastVersionCode = TextSecurePreferences.getLastVersionCodeForAnonymous(context)
    ...
    TextSecurePreferences.setLastVersionCodeForAnonymous(context, currentVersionCode)
  }
