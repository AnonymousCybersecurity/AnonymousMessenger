...
data class AnonymousSocketDevice(
  val deviceId: Int,
  val password: String,
) {
  override fun toString(): String {
    return "AnonymousSocketDevice:$deviceId"
  }
}
...
enum class RegistrationStatus(val value: Int) {
  ...
  /** The UUID is forbidden by the config of AnonymousSocket */
  FORBIDDEN_UUID(5),

  /** The endpoint is forbidden by the config of AnonymousSocket */
