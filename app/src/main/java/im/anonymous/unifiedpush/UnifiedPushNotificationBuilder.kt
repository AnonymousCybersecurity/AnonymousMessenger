...
class UnifiedPushNotificationBuilder(val context: Context) {
  ...
  fun setNotificationDeviceLimitExceeded(deviceLimit: Int) {
    notify(NOTIFICATION_ID, context.getString(R.string.UnifiedPushNotificationBuilder__anonymoussocket_device_limit_hit, deviceLimit - 1))
  }


  fun setNotificationAnonymousSocketForbiddenEndpoint() {
    notify(NOTIFICATION_ID, context.getString(R.string.UnifiedPushNotificationBuilder__anonymoussocket_forbidden_endpoint))
  }

  fun setNotificationAnonymousSocketForbiddenUuid() {
    notify(NOTIFICATION_ID, context.getString(R.string.UnifiedPushNotificationBuilder__anonymoussocket_forbidden_uuid))
  }

  fun setNotificationAnonymousSocketForbiddenPassword() {
    notify(NOTIFICATION_ID, context.getString(R.string.UnifiedPushNotificationBuilder__anonymoussocket_forbidden_password))
  }
